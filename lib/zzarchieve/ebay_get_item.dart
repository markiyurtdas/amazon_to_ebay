/*import 'package:amazon_to_ebay/routes/get_item_route.dart';
import 'package:flutter/material.dart';

class EbayGetItem extends StatefulWidget {
  @override
  createState() => EbayGetItemState();
}

class EbayGetItemState extends State<EbayGetItem> {
  late String _token =
  ...
  Widget build(BuildContext context) {
    return WebServices(
      ...
      MaterialApp(
        ...
        home: GetItemRoute(title: 'Ebay Get Item'),
      ),
    );
  }
}
